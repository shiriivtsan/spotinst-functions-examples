...
[Check Out the Code](https://github.com/spotinst/spotinst-functions-examples/tree/master/python-hello-world)

This is a simpel hello world on Python using Spotinst Functions
...
```bash
serverless create --template-url https://github.com/spotinst/spotinst-functions-examples/tree/master/python-hello-world
```
