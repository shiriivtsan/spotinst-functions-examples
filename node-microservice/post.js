...
module.exports.main = function main (event, context, callback) {
    ...
    pool.getConnection((err, con) =>{
		...
		let sql = `INSERT INTO pet (name, owner, age) VALUES('${event.query.name}','${event.query.owner}','${event.query.age}')`
		...
		con.query(sql, (err, res)=>{
			...
			console.log(res)
			callback(null, {statusCode: 200, body: `Success: ${event.query.name} inserted`});
		})
		con.release();
	})
};
