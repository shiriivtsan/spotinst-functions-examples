...
```bash
serverless create --template-url https://github.com/spotinst/spotinst-functions-examples/tree/master/java8-elastigroup-scaleUp
```
...
```bash
sls invoke -f Java8ScaleUpGroup
```
